export const translations = {
  pt: {
    ...
    nav_contact: "contato →",
    nav_back: "← voltar ao portfólio",

    hero_desc:
      "Desenvolvedor fullstack especializado em Mobile & Web e entusiasta de IA — interfaces rápidas, acessíveis e centradas na experiência do usuário.",
    hero_cta_contact: "entre em contato",
    hero_cta_projects: "ver projetos",

    section_about: "00 / sobre",
    section_projects: "01 / projetos",
    section_experience: "02 / experiência",
    section_stack: "03 / stack",
    section_contact: "04 / contato",

    about_headline:
      "Código que<br><em>importa,</em><br>experiência<br>que entrega.",
    about_p1:
    ...
    stack_backend: "back-end & apis",
    stack_database: "banco de dados",
    stack_publish: "publicação",
    stack_ai: "ia & automação",

    contact_headline: "Vamos construir<br>algo <em>juntos?</em>",
    contact_cta_live: "ver projeto ao vivo ↗",
    contact_cta_back: "← todos os projetos",

    footer_copy: "© 2026 Lucas Rosa. Todos os direitos reservados.",

    proj_desc_section: "descrição",
    proj_cta_headline: "Quer ver<br>em <em>ação?</em>",
    proj_next_label: "próximo projeto",
  ...
  en: {
    ...
    hero_desc:
      "Fullstack developer specialized in Mobile & Web and AI enthusiast — fast, accessible interfaces centered on user experience.",
    hero_cta_contact: "get in touch",
    hero_cta_projects: "view projects",

    section_about: "00 / about",
    ...
    about_headline:
      "Code that<br><em>matters,</em><br>experience<br>that delivers.",
    about_p1:
    ...
    stack_frontend: "front-end web",
    stack_backend: "back-end & apis",
    stack_database: "databases",
    stack_publish: "publishing",
    stack_ai: "ai & automation",

    contact_headline: "Let's build<br>something <em>together?</em>",
    contact_cta_live: "view live project ↗",
    contact_cta_back: "← all projects",

    footer_copy: "© 2026 Lucas Rosa. All rights reserved.",

    proj_desc_section: "description",
    proj_cta_headline: "Want to see<br>it in <em>action?</em>",
    proj_next_label: "next project",
